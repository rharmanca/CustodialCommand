...
From `shared/schema.ts` inspectionSchema:
- Physical: floors, walls, windows, doors
- Service: restrooms, breakrooms, storage
- Compliance: safety, hazmat, signage
- Satisfaction: overall, recommendation
</context>
...
```typescript
const RATING_GROUPS = [
  { id: 'physical', label: 'Physical Condition', icon: Building2, 
    fields: ['floors', 'walls', 'windows', 'doors'] },
  { id: 'service', label: 'Service Areas', icon: Coffee,
    fields: ['restrooms', 'breakrooms', 'storage'] },
  { id: 'compliance', label: 'Compliance & Safety', icon: Shield,
    fields: ['safety', 'hazmat', 'signage'] },
  { id: 'satisfaction', label: 'Overall Satisfaction', icon: Star,
    fields: ['overall', 'recommendation'] }
];
```
