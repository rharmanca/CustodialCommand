    ...
    app.get("/api/inspections", async (req, res) => {
        try {
            ...
            if (type === 'whole_building' && incomplete === 'true') {
                inspections = inspections.filter(inspection => inspection.inspectionType === 'whole_building' && !inspection.isCompleted);
            }
    ...
    app.get("/api/room-inspections", async (req, res) => {
        try {
            ...
            if (buildingInspectionId) {
                const roomInspections = await storage.getRoomInspectionsByBuildingId(parseInt(buildingInspectionId));
